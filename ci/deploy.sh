...
echo "S3_BACKUP_BUCKET_NAME=${S3_BACKUP_BUCKET_NAME}" >> "${ENV_FILE}"
echo "S3_BACKUP_IAM_USER_KEY=${S3_BACKUP_IAM_USER_KEY}" >> "${ENV_FILE}"
echo "S3_BACKUP_IAM_USER_SECRET=${S3_BACKUP_IAM_USER_SECRET}" >> "${ENV_FILE}"
echo "S3_BACKUP_REGION=${S3_BACKUP_REGION}" >> "${ENV_FILE}"
mkdir logs
